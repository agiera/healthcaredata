...
X, y = load_svmlight_file(dir_path + "/meps_2010_sf_sso.libfm")
print(np.sum(y))
X, y = load_svmlight_file(dir_path + "/meps_2011_sf_sso.libfm")
print(np.sum(y))
X, y = load_svmlight_file(dir_path + "/meps_2012_sf_sso.libfm")
print(np.sum(y))
X, y = load_svmlight_file(dir_path + "/meps_2013_sf_sso.libfm")
print(np.sum(y))
X, y = load_svmlight_file(dir_path + "/meps_2014_sf_sso.libfm")
print(np.sum(y))

print("pred 2011: " + str(pred_next_years("meps_2010_sf_sso.libfm", "meps_2010_sf_sso.libfm")))
print("pred 2012: " + str(pred_next_years("meps_2011_sf_sso.libfm", "meps_2012_sf_sso.libfm")))
print("pred 2013: " + str(pred_next_years("meps_2012_sf_sso.libfm", "meps_2013_sf_sso.libfm")))
print("pred 2014: " + str(pred_next_years("meps_2013_sf_sso.libfm", "meps_2014_sf_sso.libfm")))
